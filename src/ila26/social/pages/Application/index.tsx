...
import NewsFeedPage from '~/ila26/social/pages/NewsFeed';
import CommunityFeedPage from '~/ila26/social/pages/CommunityFeed';
import UserFeedPage from '~/ila26/social/pages/UserFeed';
