...
import ILA26_AmityUiKitSocial_wrapped from '~/ila26/social/pages/Application';
...
export const AmityUiKitSocial = withUIStyles(ILA26_AmityUiKitSocial_wrapped); // TODO: rename to ILA26_AmityUiKitSocial later (breaks ila26.Front)
